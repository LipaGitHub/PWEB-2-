<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="o_orcamento.aspx.cs" Inherits="Default2" %>
...
<asp:Content runat="server" ID="titulo" ContentPlaceHolderID="cphtitulo">
    <h1 class="intro-text text-center"><strong>Orçamento de Reparações</strong>
    </h1>
</asp:Content>